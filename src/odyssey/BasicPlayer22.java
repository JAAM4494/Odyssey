 ...
 */
public class BasicPlayer22 implements BasicController, Runnable
{
    ...
    */
    ...
    public long seek(long bytes) throws BasicPlayerException
    {
        try {
            ...
            Logger.getLogger(BasicPlayer22.class.getName()).log(Level.SEVERE, null, ex);
            return 1;
